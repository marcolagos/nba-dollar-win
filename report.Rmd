...
compute_studentized_residuals <- function(future_data, model, res_vec, exclude, k, pred_vals) {
  ...
  #team_inds <- seq(from=1, to=length(future_data$team), by=1)
	plot(pred_vals, stud_res_vec, col = "red", xlab = "Predicted values", ylab = "Studentized residuals", main="Studentized residuals versus predicted values")
...
stud_residuals_future_lasso_min <- compute_studentized_residuals(advanced_stats_2021, advanced_stats_ridge_model, residuals_future_lasso_min$residuals, aparam_min, k, residuals_future_lasso_min$predictions)
